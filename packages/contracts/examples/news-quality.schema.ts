import type { LabelHubSchema } from "../src";

export const newsQualitySchema = {
  contractVersion: "1.1",
        ...
        validations: [
          {
            ...
            when: {
              op: "in",
              left: { kind: "path", path: "$.answers.issueTags" },
              right: [
                { kind: "literal", value: "unclear_fact" },
                { kind: "literal", value: "missing_source" },
              ],
            },
            rules: [{ type: "required", message: "涉及事实或来源问题时必须填写说明" }],
          },
        ],
      },
      {
